...
from neuroinfra.contracts.parameters import (
    ParameterSpec,
    campaign_search_space_paths as _campaign_search_space_paths,
    parameter_contract_snapshot as _parameter_contract_snapshot,
    parameter_display_order as _parameter_display_order,
    search_space_paths as _search_space_paths,
    search_space_rows,
)
...
def default_search_space_paths() -> list[str]:
    return _search_space_paths(default_hfo_search_space())
...
def parameter_display_order(
    ...
    *,
    ...
    return _parameter_display_order(
        params,
        preferred_paths=preferred,
        runtime_parameter_keys=hfo_runtime_parameter_keys(),
    )
...
def parameter_contract_snapshot(
    *,
    ...
    if campaign_dir is not None:
        ...
        search_space_paths = _search_space_paths(search_space)
    else:
        search_space_paths = default_search_space_paths()
    return _parameter_contract_snapshot(
        version=PARAMETER_CONTRACT_VERSION,
        search_space_paths=search_space_paths,
        runtime_parameter_keys=hfo_runtime_parameter_keys(),
    )
...
def campaign_search_space_paths(
    ...
    *,
    ...
    return _campaign_search_space_paths(
        campaign_dir,
        fallback=fallback or default_search_space_paths(),
    )
