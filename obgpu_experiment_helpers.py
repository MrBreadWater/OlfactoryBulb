...
_OBGPU_ANALYSIS_PROFILE = _build_olfactorybulb_analysis_profile(
    _OlfactoryBulbAnalysisProfileHooks(
        ...
        split_traces_by_type_fn=split_traces_by_type,
        list_available_cell_types_fn=list_available_cell_types,
        list_available_soma_labels_fn=list_available_soma_labels,
        saved_voltage_summary_signal_fn=_saved_voltage_summary_signal,
        collect_spike_frequency_samples_fn=collect_spike_frequency_samples,
        normalize_cell_name_fn=normalize_cell_name,
