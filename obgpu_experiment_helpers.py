...
from olfactorybulb.analysis_data import (
    OLFACTORY_BULB_CATEGORY_CATALOG_HOOKS as _OLFACTORY_BULB_CATEGORY_CATALOG_HOOKS,
    calculate_instantaneous_frequency as _ob_calculate_instantaneous_frequency,
    cell_type_of as _ob_cell_type_of,
    collect_spike_frequency_samples as _ob_collect_spike_frequency_samples,
    detect_spikes as _ob_detect_spikes,
    list_available_cell_types as _ob_list_available_cell_types,
    list_available_soma_labels as _ob_list_available_soma_labels,
    normalize_cell_name as _ob_normalize_cell_name,
    saved_soma_spike_rows as _ob_saved_soma_spike_rows,
    saved_voltage_summary_signal as _ob_saved_voltage_summary_signal,
    split_traces_by_type as _ob_split_traces_by_type,
)
from olfactorybulb.analysis_views import (
    build_soma_spike_raster_suite as _ob_build_soma_spike_raster_suite,
...
from olfactorybulb.notebook_remote_runs import (
    NotebookRemoteRunWorkflowBuilderHooks as _OlfactoryBulbNotebookRemoteRunWorkflowBuilderHooks,
    RemoteRunPayloadHooks as _OlfactoryBulbRemoteRunPayloadHooks,
    build_remote_run_payload as _ob_build_remote_run_payload,
    build_remote_run_workflow_hooks as _ob_build_remote_run_workflow_hooks,
)
from olfactorybulb.notebook_remote_sweeps import (
    NotebookRemoteSweepWorkflowBuilderHooks as _OlfactoryBulbNotebookRemoteSweepWorkflowBuilderHooks,
    RemoteSweepPayloadHooks as _OlfactoryBulbRemoteSweepPayloadHooks,
...
from olfactorybulb.notebook_run_configs import (
    DEFAULT_RESULTS_BASE as _OLFACTORY_BULB_DEFAULT_RESULTS_BASE,
    REPO_ROOT as _OLFACTORY_BULB_NOTEBOOK_REPO_ROOT,
    apply_param_override_object as _ob_apply_param_override_object,
    build_param_overrides as _ob_build_param_overrides,
    build_run_config as _ob_build_run_config,
    build_slurm_remote_config as _ob_build_slurm_remote_config,
    build_sol_remote_config as _ob_build_sol_remote_config,
    deep_update as _ob_deep_update,
    default_local_mpi_exec as _ob_default_local_mpi_exec,
    default_remote_mpi_exec as _ob_default_remote_mpi_exec,
    default_sol_runtime_profiles as _ob_default_sol_runtime_profiles,
    extract_runtime_control_snapshot as _ob_extract_runtime_control_snapshot,
    make_label as _ob_make_label,
    make_timestamp as _ob_make_timestamp,
    normalize_input_odors as _ob_normalize_input_odors,
    resolve_effective_params as _ob_resolve_effective_params,
    resolve_execution_mode as _ob_resolve_execution_mode,
    resolve_paramset_defaults as _ob_resolve_paramset_defaults,
    snapshot_param_object as _ob_snapshot_param_object,
    warn_remote_execution_mode_reset as _ob_warn_remote_execution_mode_reset,
)
...
from olfactorybulb.analysis_profile import (
    OlfactoryBulbAnalysisProfileHooks as _OlfactoryBulbAnalysisProfileHooks,
    build_olfactorybulb_analysis_profile as _build_olfactorybulb_analysis_profile,
)

REPO_ROOT = _OLFACTORY_BULB_NOTEBOOK_REPO_ROOT
BENCHMARK_SCRIPT = REPO_ROOT / "tools" / "benchmarks" / "benchmark_ob.py"
DEFAULT_RESULTS_BASE = _OLFACTORY_BULB_DEFAULT_RESULTS_BASE
CONTROL_HELP = {
...
def build_slurm_remote_config(
    *,
    ...
    """
    return _ob_build_slurm_remote_config(
...
def build_sol_remote_config(
    *,
    ...
    Slurm arguments are only emitted when explicitly provided.
    """
    return _ob_build_sol_remote_config(
        remote_host=remote_host,
        remote_repo_root=remote_repo_root,
        remote_results_root=remote_results_root,
        remote_conda_activate_cmd=remote_conda_activate_cmd,
...
def default_sol_runtime_profiles(
    *,
    ...
    """
    return _ob_default_sol_runtime_profiles(
        grace_hopper_env=grace_hopper_env,
        arm_env=arm_env,
        x86_env=x86_env,
        grace_hopper_mechanism_profile=grace_hopper_mechanism_profile,
        arm_mechanism_profile=arm_mechanism_profile,
        x86_mechanism_profile=x86_mechanism_profile,
    )
...
def make_label(config: dict[str, Any], timestamp: str | None = None) -> str:
    ...
    return _ob_make_label(config, timestamp=timestamp)
...
def _warn_remote_execution_mode_reset() -> None:
    ...
    _ob_warn_remote_execution_mode_reset()
...
def _ob_remote_sweep_payload_hooks() -> _OlfactoryBulbRemoteSweepPayloadHooks:
    ...
    return _OlfactoryBulbRemoteSweepPayloadHooks(
        ...
        remote_sweep_parallelism_fn=_remote_sweep_parallelism,
        require_remote_host_fn=_require_remote_host,
        default_remote_mpi_exec_fn=default_remote_mpi_exec,
    )
...
def _ob_remote_run_workflow_builder_hooks() -> _OlfactoryBulbNotebookRemoteRunWorkflowBuilderHooks:
    ...
    return _OlfactoryBulbNotebookRemoteRunWorkflowBuilderHooks(
        ...
        remote_run_artifact_hooks_fn=_remote_run_artifact_hooks,
        build_remote_run_payload_fn=lambda config, **kwargs: _ob_build_remote_run_payload(
            _ob_remote_run_payload_hooks(),
            config,
            **kwargs,
        ),
        upload_remote_text_file_fn=_upload_remote_text_file,
        json_ready_fn=_json_ready,
        remote_fast_sync_files_fn=_remote_fast_sync_files,
...
def _ob_remote_sweep_workflow_builder_hooks() -> _OlfactoryBulbNotebookRemoteSweepWorkflowBuilderHooks:
    ...
    return _OlfactoryBulbNotebookRemoteSweepWorkflowBuilderHooks(
        ...
        remote_sweep_artifact_hooks_fn=_remote_sweep_artifact_hooks,
        build_remote_submit_command_fn=_build_remote_submit_command,
        upload_remote_text_file_fn=_upload_remote_text_file,
        refresh_remote_heartbeat_fn=_refresh_remote_heartbeat,
        should_sync_remote_sweep_finished_items_fn=_should_sync_remote_sweep_finished_items,
        sync_remote_result_dir_fn=_sync_remote_result_dir,
        ...
        resolve_local_sweep_item_dir_fn=_resolve_local_sweep_item_dir,
        json_ready_fn=_json_ready,
        read_json_if_present_fn=_read_json_if_present,
        progress_write=_progress_write,
        record_timing_fn=_record_timing,
...
def _run_remote_simulation(
    ...
    *,
    ...
    remote_results_root = _remote_results_root(effective_config)
    ...
    return _neuroinfra_execute_remote_run_workflow(
        ...
        hooks=_ob_build_remote_run_workflow_hooks(
            _ob_remote_run_workflow_builder_hooks(),
            label=label,
            timestamp=timestamp,
            remote_repo_root=remote_repo_root,
            remote_results_root=remote_results_root,
...
def _run_remote_sweep(
    ...
    (
        ...
        max_concurrent,
        remote_metadata,
    ) = _ob_build_remote_sweep_payload(
        _ob_remote_sweep_payload_hooks(),
        effective_config,
    ...
    return _neuroinfra_execute_remote_sweep_workflow(
        ...
        remote_metadata=remote_metadata,
        hooks=_ob_build_remote_sweep_workflow_hooks(
            _ob_remote_sweep_workflow_builder_hooks(),
            sweep_label=sweep_label,
            timestamp=timestamp,
            remote_repo_root=remote_repo_root,
            remote_sweeps_root=remote_sweeps_root,
...
def normalize_cell_name(name: Any) -> str:
    ...
    return _ob_normalize_cell_name(name)


def cell_type_of(name: Any) -> str:
    """Infer the cell family prefix such as ``MC`` or ``GC`` from a label."""
    return _ob_cell_type_of(name)


_OBGPU_CATEGORY_CATALOG_HOOKS = _OLFACTORY_BULB_CATEGORY_CATALOG_HOOKS
...
def _soma_voltage_plot_suite(
    *,
    ...
    return _ob_build_soma_voltage_plot_suite(
...
def _soma_spike_raster_suite(
    *,
    ...
    return _ob_build_soma_spike_raster_suite(
...
def _apply_param_override_object(params: Any, overrides: dict[str, Any]) -> None:
    ...
    _ob_apply_param_override_object(params, overrides)
...
def snapshot_param_object(params: Any) -> dict[str, Any]:
    ...
    return _ob_snapshot_param_object(params)
...
def resolve_paramset_defaults(paramset_name: str) -> dict[str, Any]:
    ...
    return _ob_resolve_paramset_defaults(paramset_name)
...
def resolve_effective_params(config: dict[str, Any] | None) -> dict[str, Any]:
    ...
    return _ob_resolve_effective_params(config)
...
def extract_runtime_control_snapshot(config: dict[str, Any]) -> dict[str, Any]:
    ...
    return _ob_extract_runtime_control_snapshot(config)
...
def calculate_instantaneous_frequency(
    ...
    return _ob_calculate_instantaneous_frequency(t, v, threshold=threshold)
...
def _saved_soma_spike_rows(
    ...
    *,
    ...
    return _ob_saved_soma_spike_rows(
        result,
        indices=indices,
...
def _saved_soma_spike_rows_by_type(
    ...
    *,
    ...
    return _ob_saved_soma_spike_rows_for_display(
        result,
        max_cells_per_type=max_cells_per_type,
        threshold=threshold,
        combine_mt=combine_mt,
...
def _saved_voltage_summary_signal(
    ...
    *,
    ...
    return _ob_saved_voltage_summary_signal(
        result,
        cell_type=cell_type,
        moment=moment,
        dt_ms=dt_ms,
...
def collect_spike_frequency_samples(
    ...
    return _ob_collect_spike_frequency_samples(
        result,
        indices=indices,
        cell_types=cell_types,
        modulus=modulus,
...
def split_traces_by_type(result: dict[str, Any]) -> dict[str, list[tuple[str, np.ndarray, np.ndarray]]]:
    ...
    return _ob_split_traces_by_type(result)
...
def list_available_cell_types(result: dict[str, Any]) -> list[str]:
    ...
    return _ob_list_available_cell_types(result)
...
def list_available_soma_labels(result: dict[str, Any]) -> list[str]:
    ...
    return _ob_list_available_soma_labels(result)
...
_OBGPU_ANALYSIS_PROFILE = _build_olfactorybulb_analysis_profile(
    _OlfactoryBulbAnalysisProfileHooks(
        plot_voltage_traces_fn=plot_voltage_traces,
        plot_spike_raster_fn=plot_spike_raster,
        plot_hfo_power_summary_fn=plot_hfo_power_summary,
