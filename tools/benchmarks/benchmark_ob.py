    ...
    if rank == 0:
        ...
        summary = {
            ...
            "params": {
                ...
                "lfp_electrode_location": list(getattr(ob.params, "lfp_electrode_location", [])),
                "lfp_include_cell_types": getattr(ob.params, "lfp_include_cell_types", None),
                "lfp_exclude_cell_types": getattr(ob.params, "lfp_exclude_cell_types", None),
