...
- Always use the OBGPU environment for this project. Run Python commands, tests, notebook-facing scripts, and simulation helpers with `/opt/miniconda3/envs/OBGPU/bin/python` or from an activated `OBGPU` environment, not base/system Python.
